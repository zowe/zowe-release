...
const oidc_utils_1 = __nccwpck_require__(9908);
/**
...
module.exports = __nccwpck_require__(4203)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __nccwpck_require__(8786);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __nccwpck_require__(7748);
} else {
	module.exports = __nccwpck_require__(1729);
}
...
try {
	...
	const supportsColor = __nccwpck_require__(8243);
...
const Yallist = __nccwpck_require__(8093)
...
const parseOptions = __nccwpck_require__(2756)
const {re, t} = __nccwpck_require__(7970)
const cmp = __nccwpck_require__(5516)
const debug = __nccwpck_require__(6745)
const SemVer = __nccwpck_require__(9370)
const Range = __nccwpck_require__(3769)
...
const LRU = __nccwpck_require__(8356)
const cache = new LRU({ max: 1000 })

const parseOptions = __nccwpck_require__(2756)
const Comparator = __nccwpck_require__(5845)
const debug = __nccwpck_require__(6745)
const SemVer = __nccwpck_require__(9370)
const {
  re,
...
const debug = __nccwpck_require__(6745)
const { MAX_LENGTH, MAX_SAFE_INTEGER } = __nccwpck_require__(3474)
const { re, t } = __nccwpck_require__(7970)

const parseOptions = __nccwpck_require__(2756)
const { compareIdentifiers } = __nccwpck_require__(3160)
class SemVer {
...
const parse = __nccwpck_require__(6139)
...
const eq = __nccwpck_require__(6257)
const neq = __nccwpck_require__(17)
const gt = __nccwpck_require__(4068)
const gte = __nccwpck_require__(747)
const lt = __nccwpck_require__(4921)
const lte = __nccwpck_require__(9657)
...
const compare = __nccwpck_require__(4381)
...
const {MAX_LENGTH} = __nccwpck_require__(3474)
const { re, t } = __nccwpck_require__(7970)
const SemVer = __nccwpck_require__(9370)
...
const compareBuild = __nccwpck_require__(652)
...
const internalRe = __nccwpck_require__(7970)
module.exports = {
  re: internalRe.re,
  src: internalRe.src,
  tokens: internalRe.t,
  SEMVER_SPEC_VERSION: __nccwpck_require__(3474).SEMVER_SPEC_VERSION,
  SemVer: __nccwpck_require__(9370),
  compareIdentifiers: __nccwpck_require__(3160).compareIdentifiers,
  rcompareIdentifiers: __nccwpck_require__(3160).rcompareIdentifiers,
  parse: __nccwpck_require__(6139),
  valid: __nccwpck_require__(2076),
  clean: __nccwpck_require__(6151),
  inc: __nccwpck_require__(8746),
  diff: __nccwpck_require__(5104),
  major: __nccwpck_require__(8603),
  minor: __nccwpck_require__(9710),
  patch: __nccwpck_require__(6216),
  prerelease: __nccwpck_require__(9574),
  compare: __nccwpck_require__(4381),
  rcompare: __nccwpck_require__(636),
  compareLoose: __nccwpck_require__(649),
  compareBuild: __nccwpck_require__(652),
  sort: __nccwpck_require__(9762),
  rsort: __nccwpck_require__(7858),
  gt: __nccwpck_require__(4068),
  lt: __nccwpck_require__(4921),
  eq: __nccwpck_require__(6257),
  neq: __nccwpck_require__(17),
  gte: __nccwpck_require__(747),
  lte: __nccwpck_require__(9657),
  cmp: __nccwpck_require__(5516),
  coerce: __nccwpck_require__(378),
  Comparator: __nccwpck_require__(5845),
  Range: __nccwpck_require__(3769),
  satisfies: __nccwpck_require__(7411),
  toComparators: __nccwpck_require__(7707),
  maxSatisfying: __nccwpck_require__(5828),
  minSatisfying: __nccwpck_require__(8538),
  minVersion: __nccwpck_require__(8778),
  validRange: __nccwpck_require__(6022),
  outside: __nccwpck_require__(1593),
  gtr: __nccwpck_require__(3062),
  ltr: __nccwpck_require__(3836),
  intersects: __nccwpck_require__(3415),
  simplifyRange: __nccwpck_require__(6972),
  subset: __nccwpck_require__(5014),
}
...
const { MAX_SAFE_COMPONENT_LENGTH } = __nccwpck_require__(3474)
const debug = __nccwpck_require__(6745)
...
const outside = __nccwpck_require__(1593)
...
const Range = __nccwpck_require__(3769)
const satisfies = __nccwpck_require__(7411)
const gt = __nccwpck_require__(4068)
const lt = __nccwpck_require__(4921)
const lte = __nccwpck_require__(9657)
const gte = __nccwpck_require__(747)
...
try {
  ...
  __nccwpck_require__(1410)(Yallist)
} catch (er) {}
...
module.exports.utils = __nccwpck_require__(5796)
module.exports.InvalidArgumentException = __nccwpck_require__(9405)
module.exports.pax = __nccwpck_require__(6266)
module.exports.github = __nccwpck_require__(4617)
...
const InvalidArgumentException = __nccwpck_require__(9405)
const utils = __nccwpck_require__(5796)
...
const InvalidArgumentException = __nccwpck_require__(9405)
const fs = __nccwpck_require__(5747)
const semver = __nccwpck_require__(7298)
...
if (zowePax['path']) {
	...
	releaseArtifacts['zowe']['target'] = zoweReleaseJsonObject['zowe']['filesAtSource']['zowe-*.pax'].replace(/\*/g,releaseVersion)
} 
else {
...
try {
	...
	if (smpeZipSource['path']) {
		...
		releaseArtifacts['smpe-zip']['target'] = zoweReleaseJsonObject['zowe']['filesAtSource']['zowe-smpe-*.zip'].replace(/\*/g,releaseVersion)
		logValidate(`>>[validate 5/13]>> Found SMP/e build ${smpeZipSource['path']}.`)
	}
	try {
		var smpePromoteTar = searchArtifact(
			`${zoweReleaseJsonObject['zowe']['from']}/${zoweReleaseJsonObject['zowe']['path']}/${zoweReleaseJsonObject['zowe']['filesAtSource']['smpe-promote-*.tar']}`,
			buildName,
			buildNum
		)
...
try {
	var dockerImageAmd64 = searchArtifact(
		`${zoweReleaseJsonObject['zowe']['from']}/${zoweReleaseJsonObject['zowe']['path']}/${zoweReleaseJsonObject['zowe']['filesAtSource']['server-bundle.amd64-*.tar']}`,
		buildName,
		buildNum
	)
	if (dockerImageAmd64['path']) {
		...
		releaseArtifacts['docker-amd64']['target'] = zoweReleaseJsonObject['zowe']['filesAtSource']['server-bundle.amd64-*.tar'].replace(/\*/g,releaseVersion)
...
try {
	var dockerImageSourcesAmd64 = searchArtifact(
		`${zoweReleaseJsonObject['zowe']['from']}/${zoweReleaseJsonObject['zowe']['path']}/${zoweReleaseJsonObject['zowe']['filesAtSource']['server-bundle.sources.amd64-*.tar']}`,
		buildName,
		buildNum
	)
	if (dockerImageSourcesAmd64['path']) {
		...
		releaseArtifacts['docker-amd64-sources']['target'] = zoweReleaseJsonObject['zowe']['filesAtSource']['server-bundle.sources.amd64-*.tar'].replace(/\*/g,releaseVersion)
...
try {
	var dockerImageS390x = searchArtifact(
		`${zoweReleaseJsonObject['zowe']['from']}/${zoweReleaseJsonObject['zowe']['path']}/${zoweReleaseJsonObject['zowe']['filesAtSource']['server-bundle.s390x-*.tar']}`,
		buildName,
		buildNum
	)
	if (dockerImageS390x['path']) {
		...
		releaseArtifacts['docker-s390x']['target'] = zoweReleaseJsonObject['zowe']['filesAtSource']['server-bundle.s390x-*.tar'].replace(/\*/g,releaseVersion)
...
try {
	var dockerImageSourcesS390x = searchArtifact(
		`${zoweReleaseJsonObject['zowe']['from']}/${zoweReleaseJsonObject['zowe']['path']}/${zoweReleaseJsonObject['zowe']['filesAtSource']['server-bundle.sources.s390x-*.tar']}`,
		buildName,
		buildNum
	)
	if (dockerImageSourcesS390x['path']) {
		...
		releaseArtifacts['docker-s390x-sources']['target'] = zoweReleaseJsonObject['zowe']['filesAtSource']['server-bundle.sources.s390x-*.tar'].replace(/\*/g,releaseVersion)
...
try {
	var containerization = searchArtifact(
		`${zoweReleaseJsonObject['zowe']['from']}/${zoweReleaseJsonObject['zowe']['path']}/${zoweReleaseJsonObject['zowe']['filesAtSource']['zowe-containerization-*.zip']}`,
		buildName,
		buildNum
	)
	if (containerization['path']) {
		...
		releaseArtifacts['containerization']['target'] = zoweReleaseJsonObject['zowe']['filesAtSource']['zowe-containerization-*.zip'].replace(/\*/g,releaseVersion)
...
var cliPackages = searchArtifact(
	`${zoweReleaseJsonObject['zowe-cli']['from']}/${zoweReleaseJsonObject['zowe-cli']['path']}/${zoweReleaseJsonObject['zowe-cli']['filesAtSource']['zowe-cli-package-1*.zip']}`
)
if (cliPackages['path']) {
	releaseArtifacts['cli'] = {}
	releaseArtifacts['cli']['source'] = cliPackages
	releaseArtifacts['cli']['target'] = zoweReleaseJsonObject['zowe-cli']['filesAtSource']['zowe-cli-package-1*.zip'].replace(/\*/g,releaseVersion)
...
var cliPlugins = searchArtifact(
	`${zoweReleaseJsonObject['zowe-cli']['from']}/${zoweReleaseJsonObject['zowe-cli']['path']}/${zoweReleaseJsonObject['zowe-cli']['filesAtSource']['zowe-cli-plugins-1*.zip']}`
)
if (cliPlugins['path']) {
	releaseArtifacts['cli-plugins'] = {}
	releaseArtifacts['cli-plugins']['source'] = cliPlugins
	releaseArtifacts['cli-plugins']['target'] = zoweReleaseJsonObject['zowe-cli']['filesAtSource']['zowe-cli-plugins-1*.zip'].replace(/\*/g,releaseVersion)
...
fs.writeFileSync(projectRootPath+'/tmp-release-artifacts.json', JSON.stringify(releaseArtifacts, null, 2))
console.log('####################################')
